...
def initialize_bot(bot, bot_id):
    ...
    def add_admin_command(message):
        ...
        if user_id in allowed_admin_ids:
            ...
            response = "Purchase Admin Permission to use this command by."
        bot.reply_to(message, response)
    ...
    def welcome_admin(message):
        user_name = message.from_user.first_name
        response = f'''{user_name}, Admin Commands Are Here!!:\n\n💥 /add <userId> : Add a User.\n💥 /remove <userid> Remove a User.\n💥 /allusers : Authorised Users Lists.\n💥 /logs : All Users Logs.\n💥 /broadcast : Broadcast a Message.\n💥 /clearlogs : Clear The Logs File.\n💥/set_price to set price\n💥/admin_add to add New admin\n💥/admin_remove to remove admin\n💥/alladmins to View All admin list'''
        bot.reply_to(message, response)
